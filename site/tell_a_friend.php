...
<!-- body_text //-->
    <td class="<?php echo CONTENT_WIDTH_TD; ?>"><?php include(DIR_WS_BOXES . 'panel_top.php');?><?php echo tep_draw_form('email_friend', tep_href_link(FILENAME_TELL_A_FRIEND, 'action=process&products_id=' . $HTTP_GET_VARS['products_id'])); ?>
      ...
      <tr>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td class="main indent_2"><b><?php echo FORM_TITLE_CUSTOMER_DETAILS; ?></b></td>
...
<?php echo tep_draw_infoBox_bottom();?>
          ...
          <tr>
            <td class="main indent_2"><b><?php echo FORM_TITLE_FRIEND_DETAILS; ?></b></td>
          </tr>
          <tr>
            <td>
...
<?php echo tep_draw_infoBox_bottom();?>
          ...
          <tr>
            <td class="main indent_2"><b><?php echo FORM_TITLE_FRIEND_MESSAGE; ?></b></td>
          </tr>
          <tr>
            <td>
...
<?php echo tep_draw_infoBox2_top();?>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="2">
				<tr><td><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $HTTP_GET_VARS['products_id']) . '">' . tep_image_button('button_back1.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></td>
