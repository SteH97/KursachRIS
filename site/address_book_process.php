...
<!-- body_text //-->
    <td class="<?php echo CONTENT_WIDTH_TD; ?>"><?php include(DIR_WS_BOXES . 'panel_top.php');?><?php if (!isset($HTTP_GET_VARS['delete'])) echo tep_draw_form('addressbook', tep_href_link(FILENAME_ADDRESS_BOOK_PROCESS, (isset($HTTP_GET_VARS['edit']) ? 'edit=' . $HTTP_GET_VARS['edit'] : ''), 'SSL'), 'post', 'onSubmit="return check_form(addressbook);"'); ?>
...
?>
    <table cellpadding="0" cellspacing="0" border="0">
	  <tr>
        <td class="main indent_2"><b><?php echo DELETE_ADDRESS_TITLE; ?></b></td>
      </tr>
	</table>
...
<?php echo tep_draw_infoBox_top();?>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="2"><tr>
                ...
                <td class="main" width="50%"><?php echo DELETE_ADDRESS_DESCRIPTION; ?></td>
                <td align="right" width="50%"><table border="0" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="main" align="center"><b><?php echo SELECTED_ADDRESS; ?></b><br><?php echo tep_image(DIR_WS_IMAGES . 'arrow_south_east.gif'); ?></td>
                    <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                    <td class="main"><?php echo tep_address_label($customer_id, $HTTP_GET_VARS['delete'], true, ' ', '<br>'); ?></td>
                    <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                  </tr>
                </table></td>
              </tr>
...
<?php echo tep_draw_infoBox_top();?>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="2"><tr>
                ...
                <td><?php echo '<a href="' . tep_href_link(FILENAME_ADDRESS_BOOK, '', 'SSL') . '">' . tep_image_button('button_back1.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></td>
...
<?php echo tep_draw_infoBox2_top();?>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr><td><?php echo '<a href="' . tep_href_link(FILENAME_ADDRESS_BOOK, '', 'SSL') . '">' . tep_image_button('button_back1.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></td>
                <td align="right"><?php echo tep_draw_hidden_field('action', 'update') . tep_draw_hidden_field('edit', $HTTP_GET_VARS['edit']) . tep_image_submit('button_update.gif', IMAGE_BUTTON_UPDATE); ?></td></tr>
            </table>
...
<?php echo tep_draw_infoBox2_top();?>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="2">
				<tr><td><?php echo '<a href="' . $back_link . '">' . tep_image_button('button_back1.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></td>
                <td align="right"><?php echo tep_draw_hidden_field('action', 'process') . tep_image_submit('button_continue.gif', IMAGE_BUTTON_CONTINUE); ?></td></tr>
            </table>
...
<?php echo tep_draw_bottom();?>
	...
	<?php if (!isset($HTTP_GET_VARS['delete'])) echo '</form>'; ?></td>
<!-- body_text_eof //-->
