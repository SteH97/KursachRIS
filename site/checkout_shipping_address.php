...
<!-- body_text //-->
    <td class="<?php echo CONTENT_WIDTH_TD; ?>"><?php include(DIR_WS_BOXES . 'panel_top.php');?><?php echo tep_draw_form('checkout_address', tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL'), 'post', 'onSubmit="return check_form_optional(checkout_address);"'); ?>
...
?>
   <table cellpadding="0" cellspacing="0" border="0">
	 <tr><td><?php echo $messageStack->output('checkout_address'); ?></td></tr>
	</table>
...
<?php echo tep_draw_infoBox_top();?>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="2"><tr>
                ...
                <td class="main" width="50%"><?php echo TEXT_SELECTED_SHIPPING_DESTINATION; ?></td>
...
?>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr><td class="main indent_2"><b><?php echo TABLE_HEADING_ADDRESS_BOOK_ENTRIES; ?></b></td></tr>
        </table>
...
<?php echo tep_draw_infoBox_top();?>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="2"><tr>
                <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                <td class="main" width="50%"><?php echo TEXT_SELECT_OTHER_SHIPPING_DESTINATION; ?></td>
...
?>
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main indent_2"><b><?php echo TABLE_HEADING_NEW_SHIPPING_ADDRESS; ?></b></td>
          </tr>
        </table>
...
<?php echo tep_draw_infoBox_top();?>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="2"><tr>
                <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                <td class="main" width="100%"><?php echo TEXT_CREATE_NEW_SHIPPING_ADDRESS; ?></td>
                <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              </tr>
              <tr>
                <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
...
<?php echo tep_draw_infoBox_top();?>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="2"><tr>
                ...
                <td class="main vam bg_input" align="right"><?php echo tep_draw_hidden_field('action', 'submit') . tep_image_submit('button_continue.gif', IMAGE_BUTTON_CONTINUE); ?></td>
                <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              </tr>
            </table>
...
<?php echo tep_pixel_trans();?>
     ...
     <table cellpadding="0" cellspacing="0" border="0">
	   <tr><td><?php echo '<a href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL') . '">' . tep_image_button('button_back1.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></td></tr>
	</table>
<?php
  }
?>
