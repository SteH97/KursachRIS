...
<!-- body_text //-->
    <td class="<?php echo CONTENT_WIDTH_TD; ?>"><?php include(DIR_WS_BOXES . 'panel_top.php');?><?php echo tep_draw_form('checkout_address', tep_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL'), 'post', 'onSubmit="return check_form_optional(checkout_address);"'); ?>
...
?>
          ...
          <tr>
            <td class="main indent_2"><b><?php echo TABLE_HEADING_PAYMENT_ADDRESS; ?></b></td>
          </tr>
        </table>
...
<?php echo tep_draw_infoBox_top();?>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="2"><tr>
                ...
                <td align="right" width="50%"><table border="0" cellspacing="0" cellpadding="2">
                  <tr>
                    <td class="main" align="center"><?php echo '<b>' . TITLE_PAYMENT_ADDRESS . '</b><br>' . tep_image(DIR_WS_IMAGES . 'arrow_south_east.gif'); ?></td>
                    <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
...
?>
      	<table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main indent_2"><b><?php echo TABLE_HEADING_ADDRESS_BOOK_ENTRIES; ?></b></td>
          </tr>
        </table>
...
?>
      	<table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main indent_2"><b><?php echo TABLE_HEADING_NEW_PAYMENT_ADDRESS; ?></b></td>
          </tr>
        </table>
...
<?php echo tep_draw_infoBox_top();?>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="2"><tr>
                <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                <td class="main" width="100%"><?php echo TEXT_CREATE_NEW_PAYMENT_ADDRESS; ?></td>
                <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              </tr>
              <tr>
                <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
...
<?php echo tep_draw_infoBox_top();?>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="2"><tr>
                ...
                <td class="main bg_input" align="right"><?php echo tep_draw_hidden_field('action', 'submit') . tep_image_submit('button_continue.gif', IMAGE_BUTTON_CONTINUE); ?></td>
                <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              </tr>
            </table>
...
<?php echo tep_pixel_trans();?>
	...
	<table cellpadding="0" cellspacing="0" border="0">
      <tr><td><?php echo '<a href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL') . '">' . tep_image_button('button_back1.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></td></tr>
	</table>
<?php
  }
?>
